...
2. The addition of "related context retrieves" to support cross-context access (such as that required for mother-infant measures) (See <<03-developersguide.adoc#related-context-retrieves,Related-Context Retrieves>>)

3. Simple test suite (link:tests.html[Tests])
