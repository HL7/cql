...
A summary of changes to this version can be found in the link:../history.html[Version History], and a detailed listing of changes is available in the link:../v1.3-changelog.html[1.3 Change Log].
...
link:querychange.html[Query Change Proposal]
****
