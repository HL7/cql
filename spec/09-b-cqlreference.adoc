...
Note that because CQL defines _duration_ and _difference_ operations for date/time and time valued intervals, _size_ is not defined for intervals of these types.
