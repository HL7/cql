...
CQL supports date and time values in the range [.lit]#@0001-01-01T00:00:00.0# to [.lit]#@9999-12-31T23:59:59.999# with a 1 millisecond step size.
...
|==========================
| ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*TRUE* {set:cellbgcolor:#F0F5FA} ^|TRUE ^|FALSE ^|NULL
^|*FALSE*{set:cellbgcolor:white} ^|FALSE ^|FALSE ^|FALSE
^|*NULL* {set:cellbgcolor:#F0F5FA} ^|NULL ^|FALSE ^|NULL
|==========================
...
| ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*TRUE* {set:cellbgcolor:#F0F5FA} ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*FALSE* {set:cellbgcolor:white} ^|*TRUE* ^|*TRUE* ^|*TRUE*
^|*NULL* {set:cellbgcolor:#F0F5FA} ^|*TRUE* ^|*NULL* ^|*NULL*
|=======================
...
|===========
|  ^|*NOT*
^|*TRUE* {set:cellbgcolor:#F0F5FA} ^|*FALSE*
^|*FALSE* {set:cellbgcolor:white} ^|*TRUE*
^|*NULL* {set:cellbgcolor:#F0F5FA} ^|*NULL*
|===========
...
|========================
| ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*TRUE* {set:cellbgcolor:#F0F5FA} ^|*TRUE* ^|*TRUE* ^|*TRUE*
^|*FALSE* {set:cellbgcolor:white} ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*NULL* {set:cellbgcolor:#F0F5FA} ^|*TRUE* ^|*NULL* ^|*NULL*
|========================
...
|========================
| ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*TRUE* {set:cellbgcolor:#F0F5FA} ^|*FALSE* ^|*TRUE* ^|*NULL*
^|*FALSE* {set:cellbgcolor:white} ^|*TRUE* ^|*FALSE* ^|*NULL*
^|*NULL* {set:cellbgcolor:#F0F5FA} ^|*NULL* ^|*NULL* ^|*NULL*
|========================
...
|[.id]#true t yes y 1# {set:cellbgcolor:#F0F5FA}|[.kw]#true#
|[.id]#false f no n 0# {set:cellbgcolor:white}|[.kw]#false#
|====================================
...
|[.id]#Boolean# {set:cellbgcolor:#F0F5FA} |[.kw]#true\|false#
|[.id]#Integer# {set:cellbgcolor:white}|([.sym]#-#)?#0
|[.id]#Decimal# {set:cellbgcolor:#F0F5FA} |([.sym]#-#)?\#0.0#
|[.id]#Quantity# {set:cellbgcolor:white}|([.sym]#-#)?\#0.0# '<unit>'
|[.id]#Ratio# {set:cellbgcolor:#F0F5FA} |<quantity>:<quantity>
|[.id]#Date# {set:cellbgcolor:white}|YYYY-MM-DD
|[.id]#DateTime# {set:cellbgcolor:#F0F5FA} |YYYY-MM-DDThh:mm:ss.fff([.sym]#+\|-#)hh:mm
|[.id]#Time# {set:cellbgcolor:white}|Thh:mm:ss.fff([.sym]#+\|-#)hh:mm
|===========================================
...
In this example, the result will have a unit of [.lit]#'cm'#. Note that when performing division of quantities with the same units, the result will have the default UCUM unit ('[.lit]#1#'). When a quantity has no units specified, it is treated as a quantity with the default unit ('[.lit]#1#'). When a quantity has no units specified, it is treated as a quantity with the default unit ('[.lit]#1#').
...
The [.id]#EndsWith# operator returns true if the given string starts with the given suffix.
...
The [.id]#Today# operator returns the date (with no time component) of the start timestamp associated with the evaluation request. See the [.id]#<<Now>># operator for more information on the rationale for defining the [.id]#Today# operator in this way.
