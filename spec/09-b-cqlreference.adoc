...
[source,cql]
----
ToBoolean(argument Boolean) Boolean
...
[source,cql]
----
ToConcept(argument Concept) Concept
...
[source,cql]
----
ToInteger(argument Integer) Integer
...
ToQuantity(argument Quantity) Quantity
...
ToString(argument String) String
