...
If the input string is not formatted correctly, or does not represent a valid date value, a run-time error is thrown.
...
Note that the quantity unit may be specified in singular, plural or UCUM units.
