...
Depending on different needs, models may define any context appropriate to their use case, but must define at least the unspecified context, and must identify a default context that is used when authors do not declare a specific context.
