...
|=========================================================================
|Name |Type |Description
|*codes* |[.id]#List<Code># |The list of equivalent codes representing the concept.
...
|=============================================================================================================================
|Operator |Description
|*X [.kw]#includes# Y* |Returns true if every element in list Y is also in list X, using equivalence semantics
...
|*X [.kw]#included in# Y* |Returns true if every element in list X is also in list Y, using equivalence semantics
