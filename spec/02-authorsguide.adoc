...
Note that throughout the discussion, readers may wish to refer to <<09-b-cqlreference.adoc#appendix-b-cql-reference,Appendix B – CQL Reference>> for more detailed discussion of particular concepts.
...
|*library*{set:cellbgcolor:#F0F5FA} |Header information for the library, including the name and version, if any.
|*using*{set:cellbgcolor:white} |Data model information, specifying that the library may access types from the referenced data model.
|*include*{set:cellbgcolor:#F0F5FA} |Referenced library information, specifying that the library may access constructs defined in the referenced library.
|*codesystem*{set:cellbgcolor:white} |Codesystem information, specifying that logic within the library may reference the specified codesystem by the given name.
|*valueset*{set:cellbgcolor:#F0F5FA} |Valueset information, specifying that logic within the library may reference the specified valueset by the given name.
|*code* {set:cellbgcolor:white}|Code information, specifying that logic within the library may reference the specified code by the given name.
|*concept*{set:cellbgcolor:#F0F5FA} |Concept information, specifying that logic within the library may reference the specified concept by the given name.
|*parameter*{set:cellbgcolor:white} |Parameter information, specifying that the library expects parameters to be supplied by the evaluating environment.
|*context*{set:cellbgcolor:#F0F5FA} |Patient/population context, specifying the overall context for the statements that follow.
|*define*{set:cellbgcolor:white} |The basic unit of logic within a library, a define statement introduces a named expression that can be referenced within the library, or by other libraries.
|*function*{set:cellbgcolor:#F0F5FA} |Libraries may also contain function definitions. These are most often used as part of shared libraries.
|====================================================================================================================================================================
...
The [.kw]#called# clause of the [.kw]#include# declaration is optional, and if omitted, the library is referenced by the identifier.

[[terminology]]
=== Terminology

A CQL library may contain zero or more named valuesets using the [.kw]#valueset# declaration. A valueset declaration specifies a local identifier that represents a valueset and can be used anywhere within the library that a valueset is expected.
...
This definition establishes the local identifier [.id]#"Female Administrative Sex"# as a reference to the external identifier for the valueset, an Object Identifier (OID) in this case: [.lit]#'2.16.840.1.113883.3.560.100.2'#. The external identifier need not be an OID, it may be a uniform resource identifier (URI), or any other identification system. CQL does not interpret the external id, it only specifies that the external identifier be a string that can be used to uniquely identify the valueset within the implementation environment.
...
|=====================================================================================================================================================================================
^|*Element* ^|*Description*
|*Name*{set:cellbgcolor:#F0F5FA} |A unique identifier for the parameter within the library
|*Type*{set:cellbgcolor:white} |The type of the parameter – Note that the type is only required if no default value is provided. Otherwise, the type of the parameter is determined based on the default value.
|*Default Value*{set:cellbgcolor:#F0F5FA} |An optional default value for the parameter
|=====================================================================================================================================================================================
...
|========================================================================================================================================
^|*Context* ^|*Description*
|*Patient*{set:cellbgcolor:#F0F5FA}  |The Patient context specifies that expressions should be interpreted with reference to a single patient.
|*Population*{set:cellbgcolor:white} |The Population context specifies that expressions should be interpreted with reference to the entire population of patients.
|========================================================================================================================================
...
|============================================================================================================================================
^|*Clause* ^|*Operation*
|*Relationship (with/without)*{set:cellbgcolor:#F0F5FA} |Allows relationships between the primary source and other clinical information to be used to filter the result.
|*Where*{set:cellbgcolor:white} |The where clause allows conditions to be expressed that filter the result to only the information that meets the condition.
|*Return*{set:cellbgcolor:#F0F5FA} |The return clause allows the result set to be shaped as needed, removing elements, or including new calculated values.
|*Sort*{set:cellbgcolor:white} |The sort clause allows the result set to be ordered according to any criteria as needed.
|============================================================================================================================================
...
The primary source for this query is [[.id]#Encounter#: [.id]#"Inpatient"#], and the alias is [.id]#E#. Subsequent clauses in the query must reference elements of this source by using this name.
...
This example returns a list of tuples (structured values), one for each inpatient encounter performed, where each tuple consists of the [.id]#id# of the encounter as well as a [.id]#lengthOfStay# element, whose value is calculated by taking the duration of the period for the encounter. Tuples are discussed in detail in later sections.
...
|=======================================
^|*Value* ^|*Examples*
|*Boolean*{set:cellbgcolor:#F0F5FA}  |[.kw]#true#, [.kw]#false#
|*Integer*{set:cellbgcolor:white} |[.lit]#16#, [.lit]#-28#
|*Decimal*{set:cellbgcolor:#F0F5FA}  |[.lit]#100.015#
|*String*{set:cellbgcolor:white} |[.lit]#'pending'#, [.lit]#'active'#, [.lit]#'complete'#
|*Date*{set:cellbgcolor:#F0F5FA}  |[.lit]#@2014-01-25#
|*DateTime*{set:cellbgcolor:white} |[.lit]#@2014-01-25#, +
[.lit]#@2014-01-25T14:30:14.559#
|*Time*{set:cellbgcolor:#F0F5FA}  |
[.lit]#@T12:00:00.0Z#
...
The Boolean type in CQL supports the logical values [.kw]#true# and [.kw]#false#. These values are most often encountered as the result of Comparison Operators, and can be combined with other boolean-valued expressions using Logical Operators.
...
For case- and locale-insensitive comparison, use the equivalent ([.sym]#~#) operator.
...
|*code*{set:cellbgcolor:#F0F5FA} |[.id]#String# |The identifier for the code.
|*display*{set:cellbgcolor:white} |[.id]#String# |A description of the code.
|*system*{set:cellbgcolor:#F0F5FA} |[.id]#String# |The identifier of the code system.
|*version*{set:cellbgcolor:white} |[.id]#String# |The version of the code system.
|==================================================
...
The example specifies the code [.lit]#'66071002'# from the previously defined [.id]#"SNOMED-CT:2014"# codesystem, which specifies both the [.id]#system# and [.id]#version# of the resulting code.

Note that the [.kw]#display# clause is optional. The above example references the code [.lit]#'66071002'# from the [.id]#"SNOMED-CT:2014"# code system.
...
|=========================================================================
^|*Name* ^|*Type* ^|*Description*
|*codes*{set:cellbgcolor:#F0F5FA}  |[.id]#List<Code># |The list of equivalent codes representing the concept.
|*display*{set:cellbgcolor:white} |[.id]#String# |A description of the concept.
|=========================================================================
...
^.^|*=*{set:cellbgcolor:#F0F5FA} |Equality |Returns true if the arguments are the same value
^.^|*!=* {set:cellbgcolor:white}|Inequality |Returns true if the arguments are not the same value
^.^|*>*{set:cellbgcolor:#F0F5FA} |Greater than |Returns true if the left argument is greater than the right argument
^.^|*<*{set:cellbgcolor:white} |Less than |Returns true if the left argument is less than the right argument
^.^|*>=*{set:cellbgcolor:#F0F5FA} |Greater than or equal |Returns true if the left argument is greater than or equal to the right argument
^.^|*\<=*{set:cellbgcolor:white} |Less than or equal |Returns true if the left argument is less than or equal to the right argument
^.^|*between*{set:cellbgcolor:#F0F5FA} | |Returns true if the first argument is greater than or equal to the second argument, and less than or equal to the third argument
^.^|*~*{set:cellbgcolor:white} |Equivalent |Returns true if the arguments are the same value, or are both unknown
^.^|*!~*{set:cellbgcolor:#F0F5FA} |Inequivalent |Returns true if the arguments are not equivalent
|===========================================================================================================================================
...
This is true for all the comparison operators except for equivalent ([.sym]#~#) and not equivalent ([.sym]#!~#). The equivalent operator is the same as equality, except that it returns [.kw]#true# if both of the arguments are [.kw]#null#.
...
^|*and*{set:cellbgcolor:#F0F5FA} |Logical conjunction
^|*or*{set:cellbgcolor:white} |Logical disjunction
^|*xor*{set:cellbgcolor:#F0F5FA} |Exclusive logical disjunction
^|*not*{set:cellbgcolor:white} |Logical negation
|==================================
...
|===========================================================================================================================
^|*Operator* ^|*Name* ^|*Description*
^|*+* {set:cellbgcolor:#F0F5FA}|addition |Performs numeric addition of its arguments
^|*-* {set:cellbgcolor:white}|subtraction |Performs numeric subtraction of its arguments
^|***{set:cellbgcolor:#F0F5FA} |multiply |Performs numeric multiplication of its arguments
^|*/* {set:cellbgcolor:white}|divide |Performs numeric division of its arguments
^|*div* {set:cellbgcolor:#F0F5FA}|truncated divide |Performs integer division of its arguments
^|*mod*{set:cellbgcolor:white} |modulo |Computes the remainder of the integer division of its arguments
...
^|*-* {set:cellbgcolor:#F0F5FA}|negate |Returns the negative value of its argument
...
^|*Ln*{set:cellbgcolor:#F0F5FA} |natural logarithm |Computes the natural logarithm of its argument
^|*Log*{set:cellbgcolor:white} |logarithm |Computes the logarithm of its first argument, using the second argument as the base
^|*Exp*{set:cellbgcolor:#F0F5FA} |exponent |Raises e to the power given by its argument
^|*^*{set:cellbgcolor:white} |exponentiation |Raises the first argument to the power given by the second argument
|===========================================================================================================================
...
In addition to the literals described in the Date, DateTime, and Time section, the [.id]#Date/Time# operators allow for the construction of specific date/time values based on the values for their components. For example:
...
The first example constructs the Date July 5, 2014. The second example constructs the DateTime July 5, 2014. The third example constructs a DateTime of July 5, 2014, 04:00:00.0 UTC-07:00 (Mountain Standard Time).
...
|==================================================================================
^|*Name* ^|*Type* ^|*Description*
|*Year*{set:cellbgcolor:#F0F5FA} |[.id]#Integer# |The year component of the datetime
|*Month*{set:cellbgcolor:white} |[.id]#Integer# |The month component of the datetime
|*Day*{set:cellbgcolor:#F0F5FA} |[.id]#Integer# |The day component of the datetime
|*Hour*{set:cellbgcolor:white} |[.id]#Integer# |The hour component of the datetime
|*Minute*{set:cellbgcolor:#F0F5FA} |[.id]#Integer# |The minute component of the datetime
|*Second*{set:cellbgcolor:white} |[.id]#Integer# |The second component of the datetime
|*Millisecond*{set:cellbgcolor:#F0F5FA} |[.id]#Integer# |The millisecond component of the datetime
|*Timezone Offset*{set:cellbgcolor:white} |[.id]#Decimal# |The timezone offset component of the datetime (in hours)
|==================================================================================
...
|=======================================================================
^|*Name* ^|*Type* ^|*Description*
|*Hour*{set:cellbgcolor:#F0F5FA}  |[.id]#Integer# |The hour component of the datetime
|*Minute* {set:cellbgcolor:white}|[.id]#Integer# |The minute component of the datetime
|*Second*{set:cellbgcolor:#F0F5FA}  |[.id]#Integer# |The second component of the datetime
|*Millisecond*{set:cellbgcolor:white} |[.id]#Integer# |The millisecond component of the datetime
|*Timezone Offset* {set:cellbgcolor:#F0F5FA} |[.id]#Decimal# |The timezone offset component of the datetime
|=======================================================================

Table 2‑L

As with the DateTime operator, at least the first component must be supplied, and for any particular component that is provided, all components of broader precision must be provided. If timezone offset is not supplied, it will be defaulted to the timezone offset of the timestamp associated with the evaluation request.
...
|*Today*{set:cellbgcolor:white} |Returns the date (with no time components) of the start timestamp associated with the evaluation request
|*TimeOfDay*{set:cellbgcolor:#F0F5FA}  |Returns the time-of-day of the start timestamp associated with the evaluation request
|===============================================================================================================
...
|*=* {set:cellbgcolor:#F0F5FA}|[.kw]#same as#
|*<* {set:cellbgcolor:white}|[.kw]#before#
|*>*{set:cellbgcolor:#F0F5FA} |[.kw]#after#
|*\<=*{set:cellbgcolor:white} |[.kw]#same or before#
|*>=*{set:cellbgcolor:#F0F5FA} |[.kw]#same or after#
|==================================
...
Note that these operators may still return [.kw]#null# if the date/time values involved have unspecified components at or above the specified comparison precision.
...
|*date from X*{set:cellbgcolor:#F0F5FA} |Extracts the date of its argument (with no time components) |[.id]#Date#
|*time from X*{set:cellbgcolor:white} |Extracts the time of its argument |[.id]#Time#
|*year from X*{set:cellbgcolor:#F0F5FA} |Extracts the year component its argument |[.id]#Integer#
|*month from X*{set:cellbgcolor:white} |Extracts the month component of its argument |[.id]#Integer#
|*day from X*{set:cellbgcolor:#F0F5FA} |Extracts the day component of its argument |[.id]#Integer#
|*hour from X*{set:cellbgcolor:white} |Extracts the hour component of its argument |[.id]#Integer#
|*minute from X*{set:cellbgcolor:#F0F5FA} |Extracts the minute component of its argument |[.id]#Integer#
|*second from X*{set:cellbgcolor:white} |Extracts the second component of its argument |[.id]#Integer#
|*millisecond from X*{set:cellbgcolor:#F0F5FA} |Extracts the millisecond component of its argument |[.id]#Integer#
|*timezone from X*{set:cellbgcolor:white} |Extracts the timezone offset component of its argument |[.id]#Decimal#
|==================================================================================

Table 2‑O

Note that if X is [.kw]#null#, the result is [.kw]#null#. If a date/time value does not have a particular component specified, extracting that component will result in [.kw]#null#. Note also that if the timezone offset component for a particular date/time value was not provided as part of the constructor, because the value is defaulted to the timezone offset of the evaluation request, the result of extracting the timezone offset component will be the default timezone offset, not null.
...
In addition, if either date/time value involved is not specified to the level of precision for the duration or difference being calculated, the result will be an _uncertainty_ covering the range of possible values for the duration. Subsequent comparisons using this uncertainty may result in [.kw]#null# rather than [.kw]#true# or [.kw]#false#. For a detailed discussion of the behavior of uncertainties, refer to the <<05-lanuagesemantics.adoc#uncertainty,Uncertainty>> section.

When computing duration or difference between date/time values with different timezone offsets, implementations should normalize to the timezone offset of the evaluation request timestamp.

If either or both arguments are [.kw]#null#, the result is [.kw]#null#.

For a detailed set of examples of calculating time intervals, please refer to <<15-h-timeintervalcalculations.adoc#appendix-h-time-interval-calculation-examples,Appendix H - Time Interval Calculation Examples>>.
...
|*same as*{set:cellbgcolor:#F0F5FA} |yes |yes |no |no |yes |no |no
|*before*{set:cellbgcolor:white} |yes |yes |yes |yes |no |yes |yes
|*after*{set:cellbgcolor:#F0F5FA} |yes |yes |yes |yes |no |yes |yes
|*within...of*{set:cellbgcolor:white} |yes |yes |required |no |no |no |no
|*during*{set:cellbgcolor:#F0F5FA} |yes |no |no |no |no |no |no
|*includes*{set:cellbgcolor:white} |no |yes |no |no |no |no |no
|====================================================================================================
...
In addition, to provide consistent and intuitive semantics when dealing with lists, whenever an operation needs to determine whether or not a given list contains an element (including list operations discussed later such as [.kw]#intersect#, [.kw]#except#, and [.kw]#distinct#), CQL uses the notion of _equivalent_, rather than pure equality.
...
|=============================================================================================================================
^|*Operator* ^|*Description*
|*X [.kw]#includes# Y* {set:cellbgcolor:#F0F5FA}|Returns true if every element in list Y is also in list X, using equivalence semantics
|*X [.kw]#properly includes# Y*{set:cellbgcolor:white} |Returns true if every element in list Y is also in list X and list X has more elements than list Y
|*X [.kw]#included in# Y* {set:cellbgcolor:#F0F5FA}|Returns true if every element in list X is also in list Y, using equivalence semantics
|*X [.kw]#properly included in# Y*{set:cellbgcolor:white} |Returns true if every element in list X is also in list Y, and list Y has more elements than list X
|=============================================================================================================================
...
Note that the distinct operator uses the notion of equivalence ([.sym]#~#) to detect duplicates. Because equivalence is defined for all types, this means that [.kw]#distinct# can be used on lists with elements of any type. In particular, duplicates can be eliminated from lists of tuples, and the operation will use tuple equivalence (i.e. tuples are equal if they have the same type and the same values (or no value) for each element of the same name).
...
As with the [.kw]#distinct# operator, the [.kw]#intersect3, and [.kw]#except# operators use the equivalent operator to determine when two elements are the same.
...
The [.id]#Sum# operator, however, works only on lists of numbers:
...
|=========================================================================================================================================================================================================================
^|*Operator* ^|*Description*
|*Count*{set:cellbgcolor:#F0F5FA} |Returns the number of elements in its argument
|*Sum*{set:cellbgcolor:white} |Returns the numeric sum of the elements in the list
|*Min*{set:cellbgcolor:#F0F5FA} |Returns the minimum value of any element in the list
|*Max*{set:cellbgcolor:white} |Returns the maximum value of any element in the list
|*Avg*{set:cellbgcolor:#F0F5FA} |Returns the numeric average (mean) of all elements in the list
|*Median*{set:cellbgcolor:white} |Returns the statistical median of all elements in the list
|*Mode*{set:cellbgcolor:#F0F5FA} |Returns the most frequently occurring value in the list
|*StdDev*{set:cellbgcolor:white} |Returns the sample standard deviation (square root of the sample variance) of the elements in the list
|*PopStdDev*{set:cellbgcolor:#F0F5FA} |Returns the population standard deviation (square root of the population variance) of the elements in the list
|*Variance*{set:cellbgcolor:white} |Returns the sample variance (average distance of the data elements from the sample mean, corrected for bias by using N-1 as the denominator in the mean calculation, rather than N) of the elements in the list
|*PopVariance*{set:cellbgcolor:#F0F5FA} |Returns the population variance (average distance of the data elements from the population mean) of the elements in the list
|*AllTrue*{set:cellbgcolor:white} |Returns true if all the elements in the list are true, false otherwise
|*AnyTrue*{set:cellbgcolor:#F0F5FA} |Returns true if any of the elements in the list are true, false otherwise
|=========================================================================================================================================================================================================================
...
These statements define the [.id]#InPharyngitis# expression as true if the Code-valued expression [.id]#SomeCodeValue# is in the [.id]#"Acute Pharyngitis"# valueset. Note that valueset membership is based strictly on the definition of equivalence (i.e. two codes are the same if they have the same values for the code, system, and version elements). CQL explicitly forbids the notion of _terminological_ _equivalence_ among codes being used in this context.
...
|================================================================================================================================================
^|*Operator* ^|*Description*
|*AgeInYearsAt(X)*{set:cellbgcolor:#F0F5FA} |Determines the age of the patient in years as of the date X
|*AgeInYears()*{set:cellbgcolor:white} |Determines the age of the patient in years as of today. Equivalent to AgeInYearsAt(Today())
|*AgeInMonthsAt(X)*{set:cellbgcolor:#F0F5FA} |Determines the age of the patient in months as of the date X
|*AgeInMonths()*{set:cellbgcolor:white} |Determines the age of the patient in months as of today. Equivalent to AgeInMonthsAt(Today())
|*AgeInDaysAt(X)*{set:cellbgcolor:#F0F5FA} |Determines the age of the patient in days as of the date X
|*AgeInDays()*{set:cellbgcolor:white} |Determines the age of the patient in days as of today. Equivalent to AgeInDaysAt(Today())
|*AgeInHoursAt(X)*{set:cellbgcolor:#F0F5FA} |Determines the age of the patient in hours as of the date/time X
|*AgeInHours()*{set:cellbgcolor:white} |Determines the age of the patient in hours as of now. +
Equivalent to AgeInHoursAt(Now())
|*CalculateAgeInYearsAt(D, X)* {set:cellbgcolor:#F0F5FA}|Determines the age of a person with birthdate D in years as of the date X
|*CalculateAgeInYears(D)*{set:cellbgcolor:white} |Determines the age of a person with birthdate D in years as of today. Equivalent to CalculateAgeInYearsAt(D, Today())
|*CalculateAgeInMonthsAt(D, X)*{set:cellbgcolor:#F0F5FA} |Determines the age of a person with birthdate D in months as of the date X
|*CalculateAgeInMonths(D)*{set:cellbgcolor:white} |Determines the age of a person with birthdate D in months as of today. Equivalent to CalculateAgeInMonthsAt(D, Today())
|*CalculateAgeInDaysAt(D, X)* {set:cellbgcolor:#F0F5FA}|Determines the age of a person with birthdate D in days as of the date X
|*CalculateAgeInDays(D)*{set:cellbgcolor:white} |Determines the age of a person with birthdate D in days as of today. Equivalent to CalculateAgeInDaysAt(D, Today())
|*CalculateAgeInHoursAt(D, X)*{set:cellbgcolor:#F0F5FA} |Determines the age of a person with birthdate D in hours as of the datetime X
|*CalculateAgeInHours(D)*{set:cellbgcolor:white} |Determines the age of a person with birthdate D in hours as of now. Equivalent to CalculateAgeInHoursAt(D, Now())
|================================================================================================================================================
...
Although the examples in this guide focus on populations of patients, CQL can also be used to express non-patient-based artifacts such as episode-of-care measures, or organizational measures such as number of staff in a facility. For examples of these types of measures, see the <<15-h-timeintervalcalculations.adoc#appendix-h-time-interval-calculation-examples,Examples>> included with this specification.
...
|*Patient Characteristic Birthdate* {set:cellbgcolor:#F0F5FA}|Patient.birthDate
|*Patient Characteristic Sex*{set:cellbgcolor:white} |Patient.gender
|*Diagnosis* {set:cellbgcolor:#F0F5FA}|Condition
|*Laboratory Test, Order*{set:cellbgcolor:white} |DiagnosticOrder
|*Laboratory Test, Result*{set:cellbgcolor:#F0F5FA} |DiagnosticReport
|===================================================
