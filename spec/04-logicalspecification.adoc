...
==== codeComparator
The codeComparator attribute specifies how elements of the code property should be matched to the terminology. One of 'in', 'contains', '=', or '~'. Note that 'in' and 'contains' will resolve to the appropriate terminology matching operator, resulting in equivalence semantics for value set and code system membership testing.
...
Conversion between String and Date/DateTime/Time is checked using the ISO-8601 standard format: YYYY-MM-DDThh:mm:ss(+|-)hh:mm.footnote:formatting-strings[See <<09-b-cqlreference.adoc#formatting-strings,Formatting Strings>> for a description of the formatting strings used in this specification.]
...
Conversion between String and Date/DateTime/Time is performed using the ISO-8601 standard format: YYYY-MM-DDThh:mm:ss(+|-)hh:mm.footnote:formatting-strings[]
...
YYYY-MM-DD footnote:formatting-strings[]
...
(+|-)?\#0(.0#)?footnote:formatting-strings[]
...
(+|-)?\#0(.0#)?('<unit>')?footnote:formatting-strings[]
...
hh:mm:ss.fff footnote:formatting-strings[]
...
The ToString operator converts the value of its argument to a String value. The operator uses the following string representations for each type:footnote:formatting-strings[]
