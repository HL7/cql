...
A structure diagram of the types of literals supported can be seen link:cql-structure-diagram.html#literal[here].
...
A structure diagram of the standard escape sequences for string literals supported can be seen link:cql-structure-diagram.html#ESC[here].
...
A structure diagram of the keywords supported can be seen link:cql-structure-diagram.html#keyword[here].
...
A structure diagram of the _reserved_ words supported can be seen link:cql-structure-diagram.html#reservedWord[here].
...
A structure diagram of the types of _identifiers_ in CQL can be seen link:cql-structure-diagram.html#identifier[here].
...
A structure diagram of quoted identifier can be seen link:cql-structure-diagram.html#QUOTEDIDENTIFIER[here].
...
A structure diagram of a _qualified identifier_ can be seen link:cql-structure-diagram.html#qualifiedIdentifier[here].
...
A structure diagram of a library construct can be seen link:cql-structure-diagram.html#library[here].
...
A structure diagram of the access modifiers can be seen link:cql-structure-diagram.html#accessModifier[here].
...
A structure diagram of the _type specifiers_ in CQL can be seen link:cql-structure-diagram.html#typeSpecifier[here].
...
A structure diagram of a _named type specifier_ construct can be seen link:cql-structure-diagram.html#namedTypeSpecifier[here].
...
A structure diagram of a _tuple type specifier_ construct can be seen link:cql-structure-diagram.html#tupleTypeSpecifier[here].
...
A structure diagram of a _interval type specifier_ construct can be seen link:cql-structure-diagram.html#intervalTypeSpecifier[here].
...
A structure diagram of a _list type specifier_ construct can be seen link:cql-structure-diagram.html#listTypeSpecifier[here].
...
A structure diagram of a _choice type specifier_ construct can be seen link:cql-structure-diagram.html#choiceTypeSpecifier[here].
...
A structure diagram of an `aggregate` clause construct can be seen link:cql-structure-diagram.html#aggregateClause[here].
...
A structure diagram of a function defintion can be seen link:cql-structure-diagram.html#functionDefinition[here].
...
A structure diagram of defining a function can be seen link:cql-structure-diagram.html#function[here].
