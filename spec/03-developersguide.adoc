...
|*ToDate(DateTime)* |Converts a DateTime to a DateTime. This is equivalent to invoking date from on the DateTime value
...
|*ToTime(String)* |Converts the string representation of a time value to a Time value using ISO-8601 format: Thh:mm:ss.fff
